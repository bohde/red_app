...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        addEvent(filter_input, 'keyup', function(e) { SelectFilter.filter_key_up(e, field_id); return false;});
        addEvent(filter_input, 'keydown', function(e) {  SelectFilter.filter_key_down(e, field_id); return false; });
        addEvent(from_box, 'keyup', function(e) { SelectFilter.filter_key_up_from(e, field_id); });
        addEvent(from_box, 'keydown', function(e) { SelectFilter.filter_key_down_from(e, field_id); });
        addEvent(to_box, 'keyup', function(e) { SelectFilter.filter_key_up_from(e, field_id); });
        addEvent(to_box, 'keydown', function(e) { SelectFilter.filter_key_down_to(e, field_id); });
    ...
    filter_key_down_from: function(event, field_id) {
        from = document.getElementById(field_id + '_from');
        // right arrow -- move across
        if ((event.which && event.which == 39) || (event.keyCode && event.keyCode == 39) ||
    ...
    filter_key_up_from: function(event, field_id) {
        // don't submit form if user pressed Enter
        if ((event.which && event.which == 13) || (event.keyCode && event.keyCode == 13)) {
            event.preventDefault();
            return false;
